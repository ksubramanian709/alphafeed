      ...
      <div>
        <div className="flex items-center gap-3 mb-1">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-widest text-amber-400
            bg-amber-500/10 border border-amber-500/20 px-2 py-0.5 rounded-full">
            Live
          </span>
        </div>
        <p className="text-sm text-slate-500">
          Energy, metals, grains, softs, livestock, index futures, rates and FX — full CME/CBOT/NYMEX/COMEX/ICE universe.
        </p>
      </div>
